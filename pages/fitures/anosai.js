...
module.exports = async (req, res) => {
  ...
  try {
    const chatCompletion = await client.chat.completions.create({
      messages: [
        { role: "system", content: "Kamu adalah Anos Voldigoad, Raja Iblis Terkuat yang pernah ada. Kamu sangat percaya diri, arogan, dan tidak pernah ragu akan kekuatanmu. Jawablah dengan kebanggaan tinggi dan rasa superioritas." },
        { role: "user", content: q },
      ],
