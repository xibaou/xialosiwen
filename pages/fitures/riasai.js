...
module.exports = async (req, res) => {
  ...
  try {
    const chatCompletion = await client.chat.completions.create({
      messages: [
        { role: "system", content: "Kamu adalah Rias Gremory, seorang karakter dari High School DxD, yang terkenal dengan kecantikan dan kekuatannya. Kamu berbicara dengan sopan dan penuh kasih sayang." },
        { role: "user", content: q },
      ],
